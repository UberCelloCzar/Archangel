...
namespace Archangel
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.Draw(titleMenu, new Rectangle(0, 0, 1600, 900), Color.White);
            }

            if (menuState == Menu.help)
            {
                spriteBatch.Draw(helpMenu, new Rectangle(0, 0, 1600, 900), Color.White);
            }

            if (menuState == Menu.game)
            {
                spriteBatch.Draw(background, new Rectangle(0, 0, 1600, 900), Color.White);
            ...
            {
                spriteBatch.Draw(pauseMenu, new Rectangle(0, 0, 1600, 900), Color.White);
            }
            if (menuState == Menu.end)
            {
                spriteBatch.Draw(gameOver, new Rectangle(0, 0, 1600, 900), Color.White);
            }
            spriteBatch.End();
